...
export function TextList({ responses }: Props) {
    ...
    <div className="w-full max-w-2xl mx-auto py-2">
      <div className="space-y-2.5 max-h-[55vh] overflow-y-auto pr-1">
        {responses.map((r, i) => (
          <div
            key={r.id || i}
            className="flex items-start gap-3 rounded-2xl bg-white border-2 border-slate-200/90 p-4 transition-all hover:border-slate-300 shadow-xs"
          >
